...
<body>
<a href="#list-direccion" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="list-direccion" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="comuna" title="${message(code: 'direccion.comuna.label', default: 'Comuna')}"/>
        ...
        <g:each in="${direccionInstanceList}" status="i" var="direccionInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${direccionInstance.id}">${fieldValue(bean: direccionInstance, field: "calle")}</g:link></td>
