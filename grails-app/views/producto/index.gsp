...
<div id="list-producto" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="precioActual"
                              title="${message(code: 'producto.precioActual.label', default: 'Precio Actual')}"/>
        ...
        <g:each in="${productoInstanceList}" status="i" var="productoInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${productoInstance.id}">${fieldValue(bean: productoInstance, field: "nombre")}</g:link></td>

                <td>${fieldValue(bean: productoInstance, field: "precioActual")}</td>

                <td>${fieldValue(bean: productoInstance, field: "stock")}</td>

                <td>${fieldValue(bean: productoInstance, field: "proveedor")}</td>
