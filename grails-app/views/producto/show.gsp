...
<div id="show-producto" class="content scaffold-show" role="main">
    ...
    <ol class="property-list producto">
        ...
        <g:if test="${productoInstance?.precioActual}">
            <li class="fieldcontain">
                <span id="precioActual-label" class="property-label"><g:message code="producto.precioActual.label"
                                                                                default="Precio Actual"/></span>

                <span class="property-value" aria-labelledby="precioActual-label"><g:fieldValue
                        bean="${productoInstance}" field="precioActual"/></span>
        ...
        <g:if test="${productoInstance?.stock}">
            <li class="fieldcontain">
                <span id="stock-label" class="property-label"><g:message code="producto.stock.label"
                                                                         default="Stock"/></span>

                <span class="property-value" aria-labelledby="stock-label"><g:fieldValue bean="${productoInstance}"
                                                                                         field="stock"/></span>
        ...
        <g:if test="${productoInstance?.proveedor}">
            <li class="fieldcontain">
                <span id="proveedor-label" class="property-label"><g:message code="producto.proveedor.label"
                                                                             default="Proveedor"/></span>

                <span class="property-value" aria-labelledby="proveedor-label"><g:link controller="proveedor"
                                                                                       action="show"
                                                                                       id="${productoInstance?.proveedor?.id}">${productoInstance?.proveedor?.encodeAsHTML()}</g:link></span>
